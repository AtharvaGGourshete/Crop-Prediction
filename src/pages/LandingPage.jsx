  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2">
        <div className="grid grid-rows-2 ml-20 mt-20">
          <SplitText
            text="KrishiNiti"
            ...
            rootMargin="-50px"
          />
          <span className="text-center -mt-10 text-xl text-gray-300">
      ...
      <div className="relative mt-40 border-b border-neutral-800 min-h-[800px]">
        <div className="text-center">
          <span className="bg-neutral-900 text-[#33aa75] rounded-full h-6 text-3xl font-medium px-2 py-1 uppercase">
            Features
          </span>
